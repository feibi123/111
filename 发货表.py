...
import pandas as pd
variable = st.sidebar.number_input("输入可变天数", min_value=16, max_value=60, value=31)  # 可变天数
variable2 = st.sidebar.number_input("输入30天安全库存", min_value=1, max_value=30, value=30)  # 30天安全库存
