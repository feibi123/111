...
# 创建示例数据
data = {'姓名nanananananananannananan': ['小明nanananananannana', '小红', '小刚'] * 100,
        '年nananananananananan龄': [18, 19, 20] * 100,
        '性nananananan别': ['男nananananannanananan', '女', '男'] * 100,
        '身nanananan高': ['男', '女', '男'] * 100,
        '体ananananannananananan重': ['男', '女', '男'] * 100}
