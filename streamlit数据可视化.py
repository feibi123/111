...
gridOptions['columnDefs'] = [
    ...
    {'headerName': '15天销量', 'field': '15天销量', 'width': 95},
    {'headerName': '可变销量', 'field': '可变销量', 'width': 95},
    {'headerName': '在途库存', 'field': '在途库存', 'width': 95},
    {'headerName': '在库库存', 'field': '在库库存', 'width': 95},
    {'headerName': '在库预计可售天数', 'field': '在库预计可售天数', 'flex': 1},
    {'headerName': '总预计可售天数', 'field': '总预计可售天数', 'flex': 1},
    {'headerName': '安全库存', 'field': '安全库存', 'width': 95},
    {'headerName': '最晚发货时间', 'field': '最晚发货时间', 'flex': 1},
    {'headerName': '是否发货', 'field': '是否发货', 'width': 95},
