...
uploaded_file = st.sidebar.file_uploader("上传库存表", type="csv")
...
dt['在库库存'] = round(dt['Available'] + dt['FC transfer'])
cols1 = ['sku', '在途库存', '在库库存']
